<template>
    <div class="swiper-container">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="echart_content">
                <h2>7天小时注册数量曲线图<span>（不同的日期，不同的时间点不同的注册数量）</span></h2>
                <div id="date_number"></div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="echart_content">
               <h2>服务内容条形图<span>（入户次数、报警次数、好评次数、差评次数）</span></h2>
...
export default {
  ...
  methods: {
    ...
    content_bar() {
      this.$http
        .get(this.HOSt + "/statistical/h5/operateCount")
        .then(data => {
          if (data.status === 200) {
            if (data.data.code === 200) {
              let badCount = data.data.data.badCount; //差评次数
              let callCount = data.data.data.callCount; //报警次数
              let goodCount = data.data.data.goodCount; //好评次数
              let orderCount = data.data.data.orderCount; //入户次数
